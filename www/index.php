...
<body>
    ...
    <script src="//<?php echo $enConfigClient['environment']['site_portal']; ?>/lib/js/engage.php?client_name=parx-vip&client_id=ed80d7c05ab54b5467cc498c95b1087c" type="text/javascript"></script>
